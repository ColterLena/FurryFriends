...
namespace FurryFriends.Controllers
{
    ...
    [ApiController]
    public class ClientSessionsController : ControllerBase
    {
        ...
        public ClientSessionsController(DatabaseContext context, IConfiguration config)
        {
            _context = context;
        ...
        {
            var foundUser = await _context.Clients.FirstOrDefaultAsync(user => user.Email == loginUser.Email);
